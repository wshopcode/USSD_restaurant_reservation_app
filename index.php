...
if ( $text == "" )
    {
    $response  = "CON Hullo, welcome to Early Rise Cafe! \n";
    ...
    // Will be brought to this third menu screen
        ...
        $response = "CON Table for 2 cost -UGX- 50,000.00 \n";
    ...
    {
        $response = "CON Table for 4 cost -UGX- 150,000.00 \n";
        $response .= "Enter 1 to continue \n";
        $response .= "Enter 0 to cancel";
    }
    ...
    {
        $response = "CON Table for 6 cost -UGX- 250,000.00 \n";
        $response .= "Enter 1 to continue \n";
        $response .= "Enter 0 to cancel";
        }
    ...
    {
        $response = "CON Table for 8 cost -UGX- 250,000.00 \n";
        $response .= "Enter 1 to continue \n";
        $response .= "Enter 0 to cancel";
    }
